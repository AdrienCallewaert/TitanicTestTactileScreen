document.addEventListener("DOMContentLoaded", async () => {
  ...
  async function fetchImageData() {
    const res = await fetch("Assets/Data/GalleryImagesLancement.json");
    return await res.json();
  }
  ...
  function updateTextContent() {
    ...
    document.getElementById("pageTitleLancement").textContent =
      data.pageTitleLancement?.text?.[lang] || "Lancement Page";
